        ...
        <div class="container-fluid">
          <div class="row-fluid">
            ...
            <ul class="quick-actions">
              <li class="bg_lg"> <i class="icon-book"></i>
                <h4>Uang Masuk</h4>
                <h4>Rp. <?php echo $uang; ?> ,-</h4>
              </li>
            </ul>
            <ul class="quick-actions">
              <li class="bg_lg"> <i class="icon-print"></i> <a target='_blank' href="cetak_laporan.php?konten=<?php echo $r_lihat_menu['nama_masakan']; ?>">
