    ...
    <body>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="row-fluid">
            <?php
            if ($r['id_level'] == 1 || $r['id_level'] == 3 || $r['id_level'] == 2) {
              $id_order = $_SESSION['edit_order'];
              $query_pemesan = "select * from tb_order left join tb_user on tb_order.id_user = tb_user.id_user where id_order = $id_order";
                  ...
                  <div class="widget-content nopadding">
                    <table class="table table-bordered table-invoice-full">
                      ...
                      <tbody>
                        <?php
                        $no_order_fiks = 1;
                        $query_order_fiks = "select * from tb_pesan left join tb_masakan on tb_pesan.id_masakan = tb_masakan.id_masakan where tb_pesan.id_order = '$id_order'";
                        ...
                        $query_harga = "select * from tb_order where id_order = '$id_order' and status_order = 'belum bayar'";
