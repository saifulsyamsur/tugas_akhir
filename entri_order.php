        ...
        <div class="container-fluid">
                    ...
                    <div class="widget-content nopadding">
                      <table class="table table-bordered table-invoice-full">
                        ...
                        <tbody>
                          ...
                          $query_order_fiks = "select * from tb_pesan left join tb_masakan ON tb_masakan.id_masakan = tb_pesan.id_masakan where id_order = $id_ordernya";
                          ...
                          $query_harga = "select * from tb_order where id_user = $id and status_order = 'belum bayar'";
                      ...
                      <ul class="thumbnails">
                        <div class="btn-icon-pg">
                          <ul>
                            ...
                            $query_lihat_pesan = "select * from tb_order where id_user = $id and status_order != 'sudah_bayar'";
                            ...
                            if (isset($_REQUEST['tambah_pesan'])) {
                              ...
                              $harga_menu = $_REQUEST['harga_menu'];

                              $query_tambah_pesan = "insert into tb_pesan values('', '$id/-1', '$id_masakan', '', 10000)";
                    ...
                    <div class="widget-box">
                      ...
                      <div class="widget-content nopadding">
                        <table class="table table-bordered table-striped">
                          ...
                          <tbody>
                            <?php
                            $query_draft_pesan = "select * from tb_pesan LEFT JOIN tb_masakan ON tb_masakan.id_masakan = tb_pesan.id_masakan where id_order = '$id/-1'";
          ...
          <?php
            ...
            if (isset($_POST['proses_pesan'])) {
              ...
              $query_ubah_idorder = "update tb_pesan SET id_order = '$id_ordernya' WHERE id_order = '$id/-1'";
              $sql_simpan_order = mysqli_query($conn, $query_ubah_idorder);

              $query_cari_jumlah_pesan = "select *, (tb_masakan.harga) as hargamenu from tb_pesan LEFT JOIN tb_masakan ON tb_masakan.id_masakan = tb_pesan.id_masakan where id_order = '$id_ordernya'";
              $sql_cari_jumlah_pesan = mysqli_query($conn, $query_cari_jumlah_pesan);

              while ($r_jlh_pesan = mysqli_fetch_array($sql_cari_jumlah_pesan)) {
                $jumlah = $_POST['jumlah' . $r_jlh_pesan['id_masakan']];
                // $harga = echo $r_jlh_pesan['harga_menu'];
                $query_ubah_jumlah = "update tb_pesan SET jumlah = '$jumlah', harga = '$r_jlh_pesan[hargamenu]' WHERE id_pesan = '$r_jlh_pesan[id_pesan]'";
                $sql_ubah_jumlah = mysqli_query($conn, $query_ubah_jumlah);
                echo $jumlah;
                echo $harga;
                echo $r_jlh_pesan['id_pesan'];
              }
