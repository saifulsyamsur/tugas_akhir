...
if (isset($_SESSION['id_user'])) {
  ...
  //Jumlah Pelanggan
  $query_jml_plg = "select count(*) AS jumlah_plg from tb_user natural join tb_level where id_level = 3 and status = 'aktif'";
...
?>
    ...
    <body>
      ...
      <div id="sidebar"><a href="beranda.php" class="visible-phone"><i class="icon icon-home"></i> Beranda</a>
        <ul>
          ...
          ?>
            ...
            <li> <a href="entri_order.php"><i class="icon icon-inbox"></i> <span>Entri Order</span></a> </li>
          ...
          ?>
            <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
            <li> <a href="entri_transaksi.php"><i class="icon icon-shopping-cart"></i> <span>Entri Transaksi</span></a> </li>
            <li> <a href="logout.php"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
          <?php
      ...
      <div id="content">
        ...
        ?>
          <div class="alert alert-orange alert-block">
            <center>
              <h4 class="alert-heading">SELAMAT DATANAG</h4>
              Di Sistem Pelayanan Pemesanan Liwis Bandarmasih.
              <br> Semoga Hari Anda Menyenangkan.
            </center>
          </div>
          <div class="widget-box">
            <h3 class="alert-heading" align="center">Profil Liwis Bandarmasih</h3>
            <center><img src="template/dashboard/img/logo.png"></center>
            <font size="4">
              <p align="justify">Liwis Bandarmasih Pizzeria merupakan rumah makan atau restoran yang menyediakan hidangan menu Pizza atau Pasta Italia. Berdiri pada tahun 2014 beralamat di Jalan Sultan Adam No.10 RT.10, Sungai Miai, Kecamatan Banjarmasin Utara, Kota Banjarmasin. Pizza adalah makanan disukai banyak kalangan, di Indonesia banyak tempat makan yang menjual Pizza namun menyantapnya direstoran benuansa klasik dan minimalis. Semua menunya bernuansa Negeri Menara Miring atau Italia dan juga menu selera Indonesia, menu-menu yang disajikan murni memakai bumbu-bumbu dasar tradisional Italia seperti oregano, garam, dan merica, kemudian bahan-bahanya seperti keju mozzarella, sayuran seperti tomat, bawang putih, dagingnya seperti ayam, dan sebagainya semuanya dibeli di pasar-pasar lokal di Banjarmasin. Menu andalan disini ada beberapa seperti Liwis Pizza, Carbonara, Liwis Spicy Dipolo, Margherrita. Cara pemanggangannya juga cukup unik yaitu dengan cara kayu bakar menggunakan tungku.</p>
            </font>
          </div>
        <?php
            }
      ...
      <div class="row-fluid">
        <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Saiful || Liwis Bandarmasih </div>
      </div>
