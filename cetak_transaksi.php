...
<body>
  ...
  <page size="dipakai" layout="landscape">
    ...
    <?php
      ...
      $query_order = "select * from tb_order left join tb_user on tb_order.id_order = tb_user.id_user where id_order = $id_order";
    ...
    ?>
      <center>
        ...
        <span>
          Jl. Sultan Adam No.10, RT 17, Kelurahan Sei Miai<br>
          Telp. 082155966777
        </span>
      </center>
            <hr>
